...
![Stacked anatomy of a software landing page from hero at the bottom to final call to action at the top: hero, problem and outcome, how it works, social proof, pricing summary, final CTA and FAQ](images/w06-landing-page-anatomy.svg)
...
![Table of five headline formulas for software with a pattern and example for each: outcome for whom, kill the pain, contrast, specific claim, category plus twist](images/w06-headline-formulas.svg)
...
![Five-step conversion optimization loop: find the leak, form a hypothesis from research, change copy or layout or offer, measure against a baseline, then keep or revert or dig deeper](images/w06-cro-loop.svg)
