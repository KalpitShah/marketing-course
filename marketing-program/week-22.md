...
![Four-layer planning cascade from weekly metrics review up through monthly, quarterly and annual planning](images/w22-planning-cascade.svg)
...
![One-page weekly dashboard with rows for reach, capture, activate, revenue, pipeline and learning, and columns for this week, trend and owner](images/w22-weekly-dashboard.svg)
...
![Example budget split for an early-stage software company: 30 percent content and SEO, 20 percent paid tests, 15 percent tools and data, 15 percent events and community, 10 percent brand and design, 10 percent reserve](images/w22-marketing-budget.svg)
...
![The Plan-Do-Check-Act cycle drawn as four segments of a circle](https://upload.wikimedia.org/wikipedia/commons/7/7a/PDCA_Cycle.svg)
...
![Boyd's OODA loop showing observe, orient, decide and act with feedback paths](https://upload.wikimedia.org/wikipedia/commons/3/3a/OODA.Boyd.svg)
