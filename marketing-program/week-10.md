...
![A circular flow: talk to customers and sales, write what they search and ask, distribute in their channels, capture email and signups, learn what converted, and back to the start](images/w10-content-flywheel.svg)
...
![Two-by-two of reader intent against content shelf life: evergreen library, reference and tools, publication, and newsjacking and launches](images/w10-library-vs-publication.svg)
...
![The long tail curve: a small head of high-volume items and a long tail of many low-volume items that together add up to more](https://upload.wikimedia.org/wikipedia/commons/8/8a/Long_tail.svg)
...
![Seven stages left to right: idea backlog, brief, draft, expert review, publish, distribute, refresh](images/w10-content-pipeline.svg)
