...
![Six-step strategic narrative structure: name the change in the world, show winners and losers, tease the promised land, introduce the obstacles, present the product as the bridge, prove it](images/w08-strategic-narrative.svg)
...
![Customer story arc with six beats: ordinary world, trigger event, failed attempts, turning point, new normal, proof](images/w08-story-arc.svg)
...
![Five-part demo structure over fifteen minutes: confirm the pain, show the end state, walk the path, handle objections, agree the next step](images/w08-demo-structure.svg)
