...
Set constraints at the start. Cap active initiatives at three, name one owner each, and put the weekly review in the calendar for all thirteen weeks before the quarter begins. The failure mode is a wish list with no dates; the fix is thirteen rows, each naming what ships and what gets decided.
