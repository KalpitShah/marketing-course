...
![Platform fit matrix: LinkedIn and X for B2B, YouTube and Reddit and Hacker News and Discord for developers, TikTok and Instagram for consumer](images/w14-platform-fit.svg)
...
![Founder-led distribution loop: do the work and notice something, post a specific opinionated take, replies reveal what resonates, turn winners into long-form, long-form drives signups and follows](images/w14-founder-content-loop.svg)
...
![Table of five social post formats: lesson from a mistake, before and after, contrarian take, build in public, teardown](images/w14-post-formats.svg)
...
![Social network analysis visualization showing clusters of nodes with dense internal links and sparse links between clusters](https://upload.wikimedia.org/wikipedia/commons/9/9b/Social_Network_Analysis_Visualization.png)
