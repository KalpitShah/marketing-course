...
![Two-by-two map of competitive alternatives by how well they solve the job and what they cost the buyer](images/w04-alternatives-map.svg)
...
![Positioning canvas with five components in order: competitive alternatives, unique attributes, value, best-fit customers, market category](images/w04-positioning-canvas.svg)
...
![Table comparing head-to-head, big fish small pond, and create a new game category strategies with what you say, when it works, and the risk](images/w04-category-choices.svg)
...
![Porter's five forces diagram with competitive rivalry in the center surrounded by supplier power, buyer power, threat of substitutes and threat of new entrants](https://upload.wikimedia.org/wikipedia/commons/6/66/Porters_five_forces.PNG)
