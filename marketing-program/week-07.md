...
![Four concentric layers of a software brand: promise at the center, personality and voice, distinctive assets, and experience across every touchpoint on the outside](images/w07-brand-layers.svg)
...
![Two-by-two grid with differentiated on one axis and distinctive on the other, showing invisible, recognizable but generic, better but unknown, and the goal quadrant that is both](images/w07-distinctive-vs-differentiated.svg)
...
![Rogers adopter categories under a bell curve with a cumulative S-curve of market share rising as each group adopts](https://upload.wikimedia.org/wikipedia/commons/1/11/Diffusion_of_ideas.svg)
...
![Voice chart template with columns for trait, we are, we are not, and an example line, filled with three example traits: confident, technical, warm](images/w07-voice-chart.svg)
