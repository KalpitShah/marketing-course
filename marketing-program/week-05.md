...
![Messaging hierarchy pyramid with one-line position at the top, value proposition below it, supporting messages under that, and proof points at the base](images/w05-messaging-hierarchy.svg)
...
![Four-step chain from feature to benefit to outcome to proof, with an example for each step](images/w05-features-benefits-outcomes.svg)
...
![Objection map table listing five common objections, what the buyer is really asking, and the message or proof that answers each](images/w05-objection-map.svg)
