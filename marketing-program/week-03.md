...
- [Four Fits for $100M+ Growth, Brian Balfour](https://brianbalfour.com/four-fits-growth-framework). What to take from it: the market product fit section, which argues that you should define the market first (category, who, problems, motivations) and then fit the product to it, not the reverse.
